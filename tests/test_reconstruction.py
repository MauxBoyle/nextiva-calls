...
def test_evidence_is_ordered_and_duplicate_free():
    row = candidate(segment(destination="15550200", answered="Yes"), segment(destination="15550200", answered="Yes"), segment(destination="15550300", answered="No"), segment(destination="15550400", answered="Yes - Forwarded"), segment(destination="15550500", destination_type="system"), segment(destination="15550600", answered="Maybe"))
    assert value(row, "offered_destinations") == "15550200;15550300;15550400;15550500;15550600"
    assert value(row, "offered_agent_destinations") == "15550200;15550300;15550400;15550600"
    assert value(row, "recorded_offer_agent_destinations") == "15550200;15550300"
    assert value(row, "confirmed_answered_agent_destinations") == "15550200"
    assert value(row, "forwarded_destinations") == "15550400"
    assert value(row, "unknown_status_agent_destinations") == "15550600"
...
def test_valid_pair_still_counts_when_it_also_has_an_unknown_status():
    row = candidate(
        segment(destination="15550200", answered="No"),
        segment(destination="15550200", answered="Unexpected"),
    )
    assert value(row, "recorded_offer_agent_destinations") == "15550200"
    assert value(row, "unknown_status_agent_destinations") == "15550200"
